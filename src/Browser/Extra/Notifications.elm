port module Browser.Extra.Notifications exposing
    ( Availability(..)
    , Model
    , Msg
    , body
...
import Browser.Extra.Vibration
...
vibrate : Browser.Extra.Vibration.PulsePattern -> NotificationOption
vibrate pattern =
    NotificationOption "vibrate" (Browser.Extra.Vibration.encodePulsePattern pattern)
