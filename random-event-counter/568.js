...
`,k=({state:e,onChangeRemains:t})=>{switch(e.type){case"failed":return o.createElement("p",null,"Failed");case"loading":return o.createElement("p",null,"Loading");case"loaded":return o.createElement(v,null,o.createElement(f,{count:e.data.remains,max:10,onClick:()=>t(e.data.remains-1)}),o.createElement(w,{disabled:e.data.remains>=10,onClick:()=>t(e.data.remains+1)},o.createElement(b,{role:"img","aria-label":"Go back icon"}),o.createElement("span",null,"Undo (add 1)")))}};var E=a(702),y=a(62),x=a(367),C=a(578),_=a(807),R=a(147),Z=a(761),z=a(598);function M(e,t){const a=(0,x.Z)(e,e.getTimezoneOffset()),n=(0,C.Z)(a,t.tzOffset),o=(t.tzOffset<0?"-":"+")+("00"+t.tzOffset).slice(-2)+":00";return(0,_.Z)((0,R.Z)(n.getHours()<4?(0,Z.Z)(n,1):n,{representation:"date"})+"T"+"004".slice(-2)+":00:00"+o)}const A=({profile:e})=>{const{state:t,setRemains:a}=function(e){const[t,a]=(0,o.useState)({type:"loading"}),[n,r]=(0,o.useState)(null),[s,i]=(0,o.useState)(null),l=(0,o.useMemo)((()=>M(new Date,e.server)),[e.server.tzOffset]),d=(0,o.useCallback)((e=>{n&&n.save(g,e)}),[n]);return(0,o.useEffect)((()=>{(0,E.O)(y.z.AppTimer).then((async e=>{const t=await e.getModule("timer");i((()=>t.schedule))}))}),[]),(0,o.useEffect)((()=>{if(s)return s(l,(()=>{a((e=>{if("loaded"!==e.type)return e;const t={remains:10,loggedAt:(0,R.Z)(new Date)};return d(t),{type:"loaded",data:t}}))}))}),[s,l.valueOf(),d]),(0,o.useEffect)((()=>{(0,E.O)(y.z.AppProfile).then((async t=>{const{Store:a}=await t.getModule("store");r(new a(e.id,"app_random_event_counter"))}))}),[e]),(0,o.useEffect)((()=>{n&&n.load(g).then((t=>{const n={remains:10,loggedAt:(0,R.Z)(new Date)};if(!t)return void a({type:"loaded",data:n});const o=(0,z.Z)(new Date,M((0,_.Z)(t.loggedAt),e.server));o&&d(n),a({type:"loaded",data:o?n:t})}))}),[n]),{state:t,nextReset:l,setRemains(e){const t={remains:Math.max(0,Math.min(10,e)),loggedAt:(0,R.Z)(new Date)};d(t),a((e=>"loaded"===e.type?{type:"loaded",data:t}:e))}}}(e);return o.createElement(k,{state:t,onChangeRemains:a})};var O,D=(e,t,a)=>{if(!t.has(e))throw TypeError("Cannot "+a)},S=(e,t,a)=>(D(e,t,"read from private field"),a?a.call(e):t.get(e)),T=(e,t,a,n)=>(D(e,t,"write to private field"),n?n.call(e,a):t.set(e,a),a);class H extends HTMLElement{constructor(){super(),O.set(this,void 0),this.attachShadow({mode:"open"})}connectedCallback(){if(!this.isConnected||!this.shadowRoot)return;const e=document.createElement("style");e.textContent=n,T(this,O,document.createElement("div")),this.shadowRoot.appendChild(e),this.shadowRoot.appendChild(S(this,O)),this.profile&&r.render(o.createElement(s.StyleSheetManager,{target:this.shadowRoot},o.createElement(A,{profile:this.profile})),S(this,O))}disconnectedCallback(){S(this,O)&&(r.unmountComponentAtNode(S(this,O)),T(this,O,void 0))}}O=new WeakMap}}]);